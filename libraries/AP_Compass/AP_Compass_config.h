...
/*
  AK09916 behind the ICM-20948's auxiliary I2C master, for the Gemstone O1 R5F.
  Board-gated: it depends on AP_InertialSensor_ICM20948_K3 publishing the
  streamed field, which exists only on this HAL.
*/
#ifndef AP_COMPASS_AK09916_K3_ENABLED
#define AP_COMPASS_AK09916_K3_ENABLED (CONFIG_HAL_BOARD == HAL_BOARD_CHIBIOS_K3) && HAL_GEMSTONE_INS_ICM20948
#endif
